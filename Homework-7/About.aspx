<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="WebApplication23.About" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <a href="http://goo.gl/t0MsV">
            <img 
            src="cuongleimage.jpg" alt="Click this photo for my vCard" 
            class="profileimage" />
